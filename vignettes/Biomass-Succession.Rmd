---
title: "Preparing Biomass Succession Inputs"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Preparing Biomass Succession Inputs}
...
All sample values from Biomass Succession v7.0 test files (for LANDIS-II v8):

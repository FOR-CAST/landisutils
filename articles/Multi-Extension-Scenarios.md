...
Because those stubs are not usable input, this vignette passes
`validate = FALSE` to
[`scenario()`](https://for-cast.github.io/landisutils/reference/scenario.md)
below. A real scenario is checked by
[`validate_landis_scenario()`](https://for-cast.github.io/landisutils/reference/validate_landis_scenario.md),
which reads the maps and tables the configuration references and reports
every problem it finds before LANDIS-II is ever invoked. See
[`vignette("Dynamic-Fire-Calibration")`](https://for-cast.github.io/landisutils/articles/Dynamic-Fire-Calibration.md)
and
[`?validate_landis_scenario`](https://for-cast.github.io/landisutils/reference/validate_landis_scenario.md).
...
scen <- scenario(
  ...
  validate = FALSE ## the inputs above are empty stubs; see "Stub input files"
)

scen$path
#> /tmp/RtmpKS8igf/example_MultiExt_3585563cec8e
```
...
#> >> generated by `landisutils` (v0.0.122)

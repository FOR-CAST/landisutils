...
## Each row is a fuel type index, how long that fuel persists after the disturbance, and what
## triggers it: a harvest prescription name, or a FireSeverityN / WindSeverityN keyword.
...
#> >> -----------------------------------------------
#> Spring    LeafOff    0.203125     50    1
#> Summer    LeafOn    0.500000     51    1
#> Fall    LeafOff    0.296875    100    1
#> 
...
#> 
#> PctConiferFileName    fire/PctConifer-{timestep}.tif
#> 
#> PctDeadFirFileName    fire/PctDeadFir-{timestep}.tif
```
